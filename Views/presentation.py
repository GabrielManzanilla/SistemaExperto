...
class Main(tk.Frame):
    def __init__(self, parent, controller):
        ...
        question_label = tk.Label(self, text="Bienvenido a la \"La guia del alux\"",
                                  font=("Arial", 14, "bold"), bg='#D9C3A0')
        question_label.grid(row=1, column=0, columnspan=2, padx=10, pady=10, sticky="n")
        question_label = tk.Label(self, text="Sistema diseñado para el la recolecion y almacenamiento de los sitios arqueologicos de Mexico. Para poder comenzar da click en el boton de iniciar",
